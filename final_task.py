...
class Nilai(db.Model):
    ...
    pelajaran = db.relationship(
        "Pelajaran", backref=db.backref("data_pelajaran"))
...
class User(db.Model):
    ...
    emails = db.relationship(
        "Siswa", backref=db.backref("user_email"), uselist=False)
...
def send_message():
    if request.method == 'POST':
        ...
        message = Message(subject, sender='lee.jadon.k@gmail.com', recipients=[
            email])
